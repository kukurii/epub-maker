...
const MetadataView: React.FC<MetadataViewProps> = ({ metadata, onUpdate }) => {
  ...
  return (
    <div className="p-4 md:p-10 h-full bg-[#F5F5F7] overflow-y-auto">
      <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-gray-900 tracking-tight">元数据 (Metadata)</h2>
